...
pretrained = "/data1/wym1/models/qwen_chat_1.8b"
...
with open('/home/wym1/pjs/llm_toys/STG2_API/qwen1.5-1.8b/websocket_demo.html') as f:
    html = f.read()
...
def main():
    uvicorn.run(f"{__name__}:app", host='0.0.0.0', port=12120, workers=1)
