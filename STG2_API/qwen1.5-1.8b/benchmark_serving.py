...
# 替换为你的API密钥和端点
API_URL = 'http://localhost:12120/v1/chat/completions'
...
class BenchMarkRunner:
    ...
    async def run(self):
        self.request_queue = asyncio.Queue(self.concurrency or 100)
...
def main():
    dataset_path = r'/data1/wym1/datasets/benchmark_demo/ShareGPT_V3_unfiltered_cleaned_split.json'
    tokenizer_name_or_path = '/data1/wym1/models/qwen_chat_1.8b'
    num_request = 100
    concurrency = 10
